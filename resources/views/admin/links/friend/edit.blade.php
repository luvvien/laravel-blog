...
@section('content')
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        ...
        <form action="{{ route('admin.links.friend.update') }}" id="new-form" method="post">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="follow" name="follow">
                    ...
                    <option value="0"{{$link['follow'] ? '' : ' selected'}}>普通(nofollow)</option>
                    <option value="1"{{$link['follow'] ? ' selected' : ''}}>友情链接</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="description" name="description"
                       value="{{ $link['description'] }}" required>
            </div>
